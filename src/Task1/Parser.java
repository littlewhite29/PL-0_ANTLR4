...
10.<更多标识符> → ε | , <标识符> <更多标识符>
11.<标识符> → <字母> <更多字母和数字>
12.<更多字母和数字> → ε | <字母> <更多字母和数字>'
13.<更多字母和数字>' → ε | <字母> | <数字> | <字母> <更多字母和数字>'
14.<复合语句> → BEGIN <语句> <更多语句> END
15.<更多语句> → ε | ; <语句> <更多语句>
16.<语句> → <赋值语句> | <条件语句> | <循环语句> | <复合语句> | <空语句>
17.<赋值语句> → <标识符> := <表达式>
18.<表达式> → [<加法运算符>] <项> <更多项>
19.<更多项> → ε | <加法运算符> <项> <更多项>
20.<项> → <因子> <更多因子>
21.<更多因子> → ε | <乘法运算符> <因子> <更多因子>
22.<因子> → <标识符> | <无符号整数> | (<表达式>)
23.<加法运算符> → + | -
24.<乘法运算符> → * | /
25.<条件语句> → IF <条件> THEN <语句>
26.<循环语句> → WHILE <条件> DO <语句>
27.<条件> → <表达式> <关系运算符> <表达式>
28.<关系运算符> → = | <> | < | <= | > | >=
29.<字母> → a | b | ... | x | y | z
30.<数字> → 0 | 1 | ... | 8 | 9
